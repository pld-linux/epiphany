...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/epiphany/3.3/%{name}-%{version}.tar.xz
...
BuildRequires:	gtk-webkit3-devel >= 1.7.3
...
Requires:	gtk+3-devel >= 3.3.14
Requires:	gtk-webkit3-devel >= 1.7.3
